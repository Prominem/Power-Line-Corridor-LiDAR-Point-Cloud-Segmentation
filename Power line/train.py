...
base_data = '/home/jp/project/test/powernet/data'
# data_train = base_data + '/train'
data_train = '/home/jp/project/test/pointnet_data_process/train/block'
data_test = base_data + '/test'

file_list = os.listdir(data_train)
data_label_list = []
for num_file in range(len(file_list)):
    data_path = data_train + '/' + file_list[num_file]
    data_label_piece = np.load(data_path)
    data_label_list.append(data_label_piece)
data_label = np.concatenate(data_label_list, axis=0)
print('data_label')
...
data_batches = data_label[:,:,0:7]
label_batches = np.array(data_label[:,:,-1], dtype=np.int)
data_batches_test = data_label_test[:,:,0:7]
label_batches_test = np.array(data_label_test[:,:,-1], dtype=np.int)
...
test_data = data_batches_test
test_label = label_batches_test
