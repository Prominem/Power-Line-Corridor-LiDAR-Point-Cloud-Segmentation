...
def room2blocks_plus_normalized(data_label, num_point, block_size=BLOCK_SIZE, stride=STRIDE,
    ...
    data[:, 0:3] -= min_xyz
    max_xyz = np.max(data[:,0:3], axis=0)  # shape=(3,)
    ...
    for b in range(data_batch.shape[0]):
        new_data_batch[b, :, 4] = data_batch[b, :, 0]/max_xyz[0]
        new_data_batch[b, :, 5] = data_batch[b, :, 1]/max_xyz[1]
        new_data_batch[b, :, 6] = data_batch[b, :, 2]/max_xyz[2]
        new_data_batch[b, :, 7] = data_batch[b, :, 3]
