...
# parser.add_argument('--data_dir', default='/media/jp/disk/temp/kitti/block_local_v2', help='data directory')
...
DATA_DIR = ROOT_DIR + '/data/block_local_v2'

LOG_DIR = base2_DIR + '/log_local_v2'
