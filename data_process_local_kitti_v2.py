...
def create_block(in_file_path, out_file_path):
    ...
    current_data, current_label = indoor3d_util_local_v2.room2blocks_plus_normalized(in_data_label, num_point)
...
if __name__ == '__main__':
    ...
    block = base_dir + '/data/block_local_v2'
    # block = '/media/jp/disk/temp/kitti/block_local_v2'
